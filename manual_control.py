...
import miniworld
from miniworld_custom.manual_control import ManualControl


def main():
    parser = argparse.ArgumentParser()
    parser.add_argument("--env-name", default="MiniWorld-MazeS2-v0")
    parser.add_argument(
    ...
    env = gym.make(args.env_name, view="top", render_mode="human")
    ...
    manual_control.run(args.env_name)
